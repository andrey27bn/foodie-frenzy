        ...
        <div className='max-w-7xl mx-auto relative z-10'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12'>
                ...
                <div className='space-y-6'>
                    <h2 className='text-4xl sm:text-5xl font-sacramento text-amber-400 animate-pulse'>
                        Foodie-Frenzy
                    </h2>
                    ...
                    <form onSubmit={handleSubmit} className='relative mt-4 group'>
                        ...
                        <div className='relative'>
                            ...
                            focus:border-amber-400 focus:right-4 focus:ring-amber-400/20 transition-all duration-300 placeholder-amber-200/50 pr-24'
                            required />
                            ...
                            flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-500'>
                                ...
                                via-amber-50/30 to-transparent group-hover:translate-x-full transition-transform duration-300'/>
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
                <p className='text-amber-400 text-lg mb-2 font-playfair'>
                    &copy; 2025 Foodie-Frenzy. All right reserved.
                </p>
            </div>
        </div>
    </footer>
