		...
		>
			...
			>
				<div className='max-w-4xl mx-auto'>
					<motion.h1
						className='text-5xl sm:text-6xl md:text-7xl font-bold mb-4 font-serif bg-clip-text text-transparent
				...
				<div className='max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12'>
					{features.map((f, i) => {
						...
						return (
							...
							>
								<div
									className='absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30 rounded-3xl
