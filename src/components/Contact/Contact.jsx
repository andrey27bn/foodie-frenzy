			...
			>
				...
				<div className='max-w-7xl mx-auto relative z-10'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        ...
                        duration-300 hover:scale-[1.02] animate-cart-float border-l-4 border-amber-500 hover:border-amber-400 group'
							>
								<div
							...
							<div
								className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all
                        duration-300 hover:scale-[1.02] animate-cart-float border-l-4 border-green-500 hover:border-green-400 group'
							>
								<div
							...
							<div
								className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all
                        duration-300 hover:scale-[1.02] animate-cart-float border-l-4 border-orange-500 hover:border-orange-400 group'
							>
								<div
						...
						>
							<div
								className='absolute -top-4 -right-4 w-12 h-12 bg-amber-500/30 rounded-full
                            animate-ping-slow'
							/>
							...
							<form onSubmit={handleSubmit} className='space-y-6 relative z-10'>
                                ...
                                hover:to-orange-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform
                                hover:scale-[1.02] shadow-lg hover:shadow-amber-500/20 flex items-center justify-center space-x-2 group'>
