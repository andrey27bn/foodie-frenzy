...
const AwesomeToast = ({ message, icon }) => (
    <div className='animate-slider-in fixed bottom-6 flex items-center bg-gradient-to-br from-amber-500 to-amber-600
        ...
        border-4 border-amber-700/30 transform transition-all duration-300 hover:shadow-2xl'>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                <input type="text" name='username' placeholder='Username' value={formData.username}
                    ...
                    focus:outline-none focus:ring-2 focus:ring-amber-600 transition-all duration-200 hover:scale-[1.02]' required />
